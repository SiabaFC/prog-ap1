...
def aventureiro_andar(aventureiro, direcao):
    ...
    """
    posicao = aventureiro["posicao"]
    posicaoX = int(posicao[0])
    posicaoY = int(posicao[1])
    if direcao == "W":
        posicaoY = posicaoY -1
    ...
    if posicaoX < 0 or posicaoX > 9 or posicaoY < 0 or posicaoY > 9:
        return True
    aventureiro["posicao"] = [posicaoX, posicaoY]
    return True
...
def aventureiro_defender(aventureiro, dano):
    ...
    dano = dano - aventureiro["defesa"]
    if dano > 0:
        aventureiro["vida"] = aventureiro["vida"] - int(dano)
...
def aventureiro_esta_vivo(aventureiro):
    ...
    """
    #print ("aventureiro vivo:", aventureiro["vida"] > 0)
...
def monstro_esta_vivo(monstro):
    ...
    """
    #print ("monstro vivo:",monstro["vida"] > 0)
